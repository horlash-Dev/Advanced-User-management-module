                    ...
                    <li class="nav-item">
                        ...
                        ?"active":"";?>" href="home.php"><i class="fas fa-home fa-1x m-1"></i>Home</a>
                            ...
                            <li class="nav-item">
							    ...
							    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Hi!&nbsp;<i class="fas fa-user"><?php 
							    if ($_SERVER['PHP_SELF']) {
							    	echo $cFname;
							    }?></i></a>
...
<?php //require 'template/footer.in.php'; ?>
