    ...
    <span class="navbar-toggler-icon"></span>
            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="../home.php"><i class="fas fa-home fa-1x m-1"></i>Home</a>
                    </li>
                            <li class="nav-item">
                                <a class="nav-link" href="home.php"><i class="fas fa-user-circle fa-1x m-1"></i>account info</a>
                            </li>   
                            <li class="nav-item">
                                <a class="nav-link" href=""><i class="fas fa-comment-dots fa-1x m-1"></i>feedback</a>
                            </li>   
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
							    ...
							    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Hi!&nbsp;<i class="fas fa-user"><?php echo $cFname;?></i></a>
