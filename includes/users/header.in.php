...
$Current= new session();
echo $Current->sessionData();
// echo $Current->cDob;
// echo $Current->Create_at;
// echo $Current->cPic;
// echo $Current->cVerify;
// echo $Current->cDelete;
// echo $Current->cGender;
 ?>
 <!DOCTYPE html>
<html lang="en">
<head>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        ...
                        ?"active":"";?>" href="../../home.php"><i class="fas fa-home fa-1x m-1"></i>Home</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="profile.php"><i class="fas fa-user-circle fa-1x m-1"></i>account info</a>
                            </li>   
                            <li class="nav-item">
                                <a class="nav-link" href="feedback.php"><i class="fas fa-comment-dots fa-1x m-1"></i>feedback</a>
                            </li>        
                            <li class="nav-item">
                                <a class="nav-link alertbell"  href="notification.php"><i class="fas fa-bell fa-1x m-1"></i>notification <span id="alerticon" class="badge badge-primary"></span></a>
							    </li>
							    ...
							    <div class="dropdown-menu">
							      ...
							      <a class="dropdown-item" href="../logout.in.php"> <i class="fas fa-cog"></i>logout</a>
			...
			<div class="col-lg-5 col-md-5 col-xs-5">
				<div class="content">
					<div class="content-text">
						...
						<cite class="text-left"><b>Lorem ipsum dolor sit amet, consectetur adipisicing elit</b></cite>
						<li><i class="fab fa-instagram m-1 fa-1x"></i>Lorem ipsum dolor sit amet, consectetur adipisicing</li>
						<li><i class="fab fa-instagram m-1 fa-1x"></i>Lorem ipsum dolor sit amet, consectetur adipisicing</li>
						<li><i class="fab fa-instagram m-1 fa-1x"></i>Lorem ipsum dolor sit amet, consectetur adipisicing</li>
